...
tend = 0.05;  % end of analysis time

imf = 0.; % normalized imperfection factor: it offsets the interior nodes of the fine mesh w.r.t. nodes of the coarse mesh
...
% motion:
IDf(nf) = -1; % the final node of the fine mesh corresponds to a location with prescribed displacement, so we set its value to -1!
